...
{
	public class MusteriSinifRepository : GenericRepository<MusteriSinif>, IMusteriSinifRepository
	{
		private readonly DataContext _db;

		public MusteriSinifRepository(DataContext context) : base(context)
		{
			_db = context;
		}
	}
